...
import "./HoEAccessControl.sol";

/// @title Base contract for CryptoKitties. Holds all common structs, events and base variables.
/// @author Axiom Zen (https://www.axiomzen.co)
/// @dev See the KittyCore contract documentation to understand how the various contract facets are arranged.
contract HoEBase is HoEAccessControl {
    /*** EVENTS ***/
        ...
        returns (uint)
    {
        ...
        require(_fParentId == uint256(uint32(_fParentId)));
        require(_mParentId == uint256(uint32(_mParentId)));
        ...
        Hero memory _hero = Hero({
            ...
            cooldownEndBlock: 0,
            fParentId: uint32(_fParentId),
            mParentId: uint32(_mParentId),
            siringWithId: 0,
        ...
        emit Birth(
            _owner,
            newHeroId,
            uint256(_hero.fParentId),
            uint256(_hero.mParentId),
            _hero.genes
        );
